...
- アドホックネットワークと呼ばれる、基地局を使わずに端末の中にある通信機構を使って通信する方法もP2P。DSの通信プレイとかに使われている。

### クライアントサーバモデル

![クライアントサーバモデル](computer_server_based.png)

- 機能や情報を提供する「サーバ」と、それを利用・操作する「クライアント」に役割を分けて、これらが相互にネットワークで接続されるモデル。
